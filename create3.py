...
img = cv2.imread('C:\PythonProjects/lena.png', cv2.IMREAD_COLOR)
...
labels, bgdModel, fgdMode1 = cv2.grabCut(img, labels, (x, y, w, h),None, None, 5, cv2.GC_INIT_WITH_RECT)

show_img = np.copy(img)
show_img[(labels == cv2.GC_PR_BGD)|(labels == cv2.GC_PR_BGD)] //=  3
